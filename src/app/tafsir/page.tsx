      ...
      <main className="tafsir-page">
        <section className="tafsir-hero">
          ...
          <div className="hero-image">
            <img src="/tafsir-hero-image.png" alt="Quran Tafsir Illustration" />
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="scholar-grid">
              <div className="scholar-card">
                <img src="/tafsir-ibn-kathir.jpg" alt="Ibn Kathir" />
              ...
              <div className="scholar-card featured">
                ...
                <img src="/tafsir-maariful-quran.jpg" alt="Maariful Quran" />
              ...
              <div className="scholar-card">
                <img src="/tafsir-tabari.jpg" alt="Al-Tabari" />
              ...
              <div className="scholar-card">
                <img src="/tafsir-qurtubi.jpg" alt="Al-Qurtubi" />
              ...
              <div className="scholar-card">
                <img src="/tafsir-tafheem.jpg" alt="Tafheem ul Quran" />
              ...
              <div className="scholar-card">
                <img src="/tafsir-jalalain.jpg" alt="Tafsir al-Jalalayn" />
